...
export class Backend implements backendInterface {
    ...
    async addTransaction(arg0: string, arg1: number, arg2: TransactionType, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addTransaction(arg0, arg1, to_candid_TransactionType_n1(this._uploadFile, this._downloadFile, arg2), arg3);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getTransaction(arg0: bigint): Promise<Transaction> {
        if (this.processError) {
            try {
                ...
                return from_candid_Transaction_n6(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
